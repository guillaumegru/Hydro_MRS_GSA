...
Parameters['savefn_num'] = '4' # String, number X in output file name : "GSA5_X_E1.csv"
...
Parameters['ncells_bedrock'] = 70 # Number of cells attritbuted to the bedrock zone
Parameters['ncells_per_value_thetaMRSbed'] = 70 # Number of cells attributed to each values in theta_MRS_bedrock
