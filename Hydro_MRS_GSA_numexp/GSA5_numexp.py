...
Model1Opts = {
    ...
    'Parameters' : {
        ...
        'ncells_bedrock' : 74,#Int, Number of layers of the always saturated zone associated with the bedrock zone 
        'ncells_per_value_thetaMRSbed' : 74, #Int, Number of layers in the interpolated kernel, associated with one theta_MRS value 
